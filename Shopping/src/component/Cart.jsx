...
const Cart = () => {
  ...
  return (
    <Box p={3} mt={2}>
      <Typography variant="h4" sx={{ mb: 4, color: "#D81B60", textAlign: "center", fontFamily: 'Dancing-script', fontWeight: 'bold' }}>Shopping Cart
      </Typography>

      {cartData.length === 0 ? (
        <Typography color="textSecondary" fontSize='inherit' sx={{ mt: 4, textAlign: "center" }}>
